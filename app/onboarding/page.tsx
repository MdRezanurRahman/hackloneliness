      ...
      <div className="px-5 pt-6 sm:px-0">
        <div className="flex items-center justify-between mb-3">
          <button
            onClick={back}
            disabled={step === 0}
            className="text-slate-900/50 dark:text-white/50 hover:text-slate-900 dark:hover:text-white dark:text-white text-sm disabled:opacity-0 transition-opacity"
          >
            ← Back
          </button>
          <span className="text-slate-900/40 dark:text-white/40 text-xs">
...
function StepLayout({
  ...
  return (
    <div>
      {eyebrow && <p className="text-violet-600 dark:text-violet-400 text-sm font-medium mb-2">{eyebrow}</p>}
      <h2 className="text-slate-900 dark:text-white text-2xl sm:text-3xl font-semibold leading-tight mb-2">
        {title}
      </h2>
      {subtitle && <p className="text-slate-900/50 dark:text-white/50 text-sm mb-6">{subtitle}</p>}
  ...
  return (
    <div>
      <div className="relative py-6">
        ...
        />
        <div className="flex justify-between text-[10px] text-slate-900/40 dark:text-white/40 mt-2 px-1">
          {[1, 2, 3, 4, 5].map((n) => (
      ...
      <div className="text-center mt-2">
        <p className="text-violet-700 dark:text-violet-300 font-semibold">{SOCIAL_BATTERY_LABEL(value)}</p>
