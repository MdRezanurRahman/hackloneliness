    ...
    <div className="min-h-svh w-full bg-white dark:bg-black dark:bg-black flex items-center justify-center p-5 sm:p-8">
      <div className="w-full max-w-sm text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-400 to-indigo-500 mb-5 shadow-xl shadow-violet-500/30">
          <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 text-slate-900 dark:text-white" stroke="currentColor" strokeWidth={2.5}>
            <path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        <h1 className="text-2xl font-semibold text-slate-900 dark:text-white mb-2">You&apos;re in!</h1>
        <p className="text-slate-900/60 dark:text-white/60 text-sm mb-6 leading-relaxed">
