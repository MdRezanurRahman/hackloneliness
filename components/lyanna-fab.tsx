  ...
  return (
    <>
      ...
      >
        ...
        <span className="relative text-white font-bold text-xl pointer-events-none">L</span>
        <span className="absolute bottom-1 right-1 w-3 h-3 bg-green-400 rounded-full border-2 border-slate-950 pointer-events-none" />
      </button>
